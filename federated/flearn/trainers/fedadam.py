...
class Server(BaseFedarated):
    def __init__(self, params, learner, dataset):
        print('Using Federated Adam to Train')
    ...
    def train(self):
        ...
        for i in range(self.num_rounds):
            ...
            indices, selected_clients = self.select_clients(i, num_clients=self.clients_per_round)  # weighted sampling
            ...
            for idx, c in enumerate(selected_clients):  # simply drop the slow devices
                ...
                csolns.append(updates)

            averaged_updates = self.simple_aggregate(csolns)
